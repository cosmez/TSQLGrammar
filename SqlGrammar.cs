...
using Irony.Parsing;
namespace TSQLGrammar
{
    [Language("SQL", "2008", "SQL Server 2008")]
    public class SqlGrammar : Grammar
    {
        ...
        { //SQL is case insensitive
            ...
            var selTopClause = new NonTerminal("selTopClause");
            ...
            var tableSourceOpt = new NonTerminal("tableSourceOpt");
            //var udfFunction = new NonTerminal("udfFunction");
            ...
            //ID
            Id.Rule = MakePlusRule(Id, dot, Id_simple) | MakePlusRule(Id, dot, idAll);
            ...
            tableSourceOpt.Rule = idlist | funCall;

            //From stmt
            fromClauseOpt.Rule = Empty | FROM + tableSourceOpt + joinChainOpt;

            //Detects User defined functions
            //udfFunction.Rule = Id + "(" + aggregateArg + ")";

            //Select stmt
            selectStmt.Rule = SELECT + selRestrOpt + selTopClause + selList + intoClauseOpt + fromClauseOpt + whereClauseOpt +
                              groupClauseOpt + havingClauseOpt + orderClauseOpt;
            selTopClause.Rule = Empty | TOP + "(" + number + ")";
            selRestrOpt.Rule = Empty | "ALL" | "DISTINCT";
            selList.Rule = columnItemList | "*" | funCall;
